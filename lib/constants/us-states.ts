 ...
 * Used for location-based filtering of communities and events
 */
...
/**
 * Get all state codes as an array (useful for validation schemas)
 */
export const US_STATE_CODES = US_STATES.map((s) => s.code) as [
  USStateCode,
  ...USStateCode[],
];

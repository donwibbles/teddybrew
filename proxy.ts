...
// Note: Auth checks are handled at the layout level, not in the proxy.
// This is because Auth.js with Prisma adapter requires database access,
// which is better suited to server components than the proxy layer.
